...
Au 2026-09-08, **v2.0.2 reste la version publiée de référence** ; les cinq corrections de fondation de la [PR nº 5](https://github.com/alebgl77/grafana-llmops-forge/pull/5) sont en revue, ni fusionnées ni publiées. Les parcours de comparaison et dossiers proposés restent des travaux futurs.
