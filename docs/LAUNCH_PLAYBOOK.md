# Launch Playbook — faire buzzer le repo (juillet 2026)
...
## J0 — Publication (fondations du buzz)
...
Bonus FR : `french-tech` awesome lists éventuelles + Grafana Community Dashboards (publier le JSON du FinOps sur grafana.com/dashboards avec lien repo — canal de découverte massif des admins Grafana).

## J3-J7 — Canaux (dans cet ordre)

1. **Show HN** (mardi ou mercredi, 15h-17h CET = matin US) — titre sobre factuel :
...
4. **LinkedIn FR** (ton audience DSI) — angle AI Act : *« Le 2 août 2026, les sanctions de l'AI Act s'activent. Voici le dashboard Grafana que votre auditeur voudra voir — généré en 3 commandes. »* + captures FR.
...
- **GIF terminal** (asciinema → gif) des 3 commandes + sortie discover : à ajouter en haut du README dès que possible — le facteur buzz n°1 mesuré des repos outils.
