...
As of 2026-09-14, **v2.0.2 is the released baseline**; the five foundational corrections and budget-alert lifecycle fix in [PR #5](https://github.com/alebgl77/grafana-llmops-forge/pull/5) are integrated into main but not yet included in a release. The proposed comparison and dossier workflows are future work.
